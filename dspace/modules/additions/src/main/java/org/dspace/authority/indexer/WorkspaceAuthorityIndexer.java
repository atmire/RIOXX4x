...
public class WorkspaceAuthorityIndexer implements AuthorityIndexerInterface {
    ...
    private Iterator<DCValue> metadataIterator = null;
    ...
    public boolean hasMore() {
        ...
        while ( (metadataIterator != null && metadataIterator.hasNext())
            ...
            if(metadataIterator != null && metadataIterator.hasNext()) {
                DCValue metadatum = metadataIterator.next();
                ...
                metadataIterator = Arrays.asList(currentItem.getMetadata(Item.ANY, Item.ANY, Item.ANY, Item.ANY)).iterator();
            }
        }
