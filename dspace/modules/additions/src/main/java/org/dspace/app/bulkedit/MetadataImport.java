...
public class MetadataImport
{
     ...
     *
     * @throws org.dspace.app.bulkedit.MetadataImportException if something goes wrong
     */
     ...
     *
     * @throws java.sql.SQLException if there is a problem accessing a Collection from the database, from its handle
     * @throws org.dspace.authorize.AuthorizeException if there is an authorization problem with permissions
     */
     ...
     * @throws java.sql.SQLException if there is a problem accessing a Collection from the database, from its handle
     * @throws org.dspace.authorize.AuthorizeException if there is an authorization problem with permissions
     * @throws java.io.IOException Can be thrown when moving items in communities
     * @throws org.dspace.app.bulkedit.MetadataImportException If something goes wrong to be reported back to the user
     */
     ...
     * @param changes The changes object to populate
     *
     * @throws java.sql.SQLException when an SQL error has occurred (querying DSpace)
     * @throws org.dspace.authorize.AuthorizeException If the user can't make the changes
     */
